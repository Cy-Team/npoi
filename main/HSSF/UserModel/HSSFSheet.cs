...
namespace NPOI.HSSF.UserModel
{
     ...
     */
        ...
        public void CopyTo(HSSFWorkbook dest, String name, Boolean copyStyle, Boolean keepFormulas)
        {
			...
			//newSheet.PrintSetup.UsePage = true;
			//newSheet.PrintSetup.ValidSettings = true;
			//newSheet.FitToPage = false;
			...
			// 设置标题行
			newSheet.RepeatingRows = this.RepeatingRows;
			// 设置标题列
			newSheet.RepeatingColumns = this.RepeatingColumns;
